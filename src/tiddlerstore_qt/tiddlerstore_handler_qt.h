...
class Tiddlerstore_Handler : public QWidget
{
    Q_OBJECT
...
private:
    ...
    QToolButton* add_label_del_row(
        const QString& text, QLayout* single_filter_functions, QFormLayout* filter_form_layout);
    ...
    FsHistory tiddlerstore_history;
